    ...
    return (
        <div>
            ...
            >
                ...
                <Button type="button" name="signInWithGoogle" className="w-full">Sign-in with Google</Button>
                <label htmlFor="googleAccount">Google Account</label>
                <input type="email" id="googleAccount" name="googleAccount" className="border-slate-900 border rounded-lg p-2 bg-slate-200 w-full" />
                <label htmlFor="accessScope">Access Scope</label>
                <select name="accessScope" id="accessScope" className="border-slate-900 border rounded-lg p-2 bg-slate-200 w-full">
