    ...
    return (
        <div className="w-full max-h-[75vh] overflow-y-auto overflow-x-hidden hide-scrollbar">
            ...
            >
                ...
                <input type="text" id="exchangeServerURL" className="border-slate-900 border rounded-lg p-2 bg-slate-200 w-full" />
                <label htmlFor="DomainName">Domain Name</label>
                <input type="text" id="DomainName" className="border-slate-900 border rounded-lg p-2 bg-slate-200 w-full" />
                <label htmlFor="serviceAccountUsername">Service Account Username</label>
                <input type="text" id="serviceAccountUsername" className="border-slate-900 border rounded-lg p-2 bg-slate-200 w-full" />
                <label htmlFor="serviceAccountPassword">Service Account Password</label>
                <input type="password" id="serviceAccountPassword" className="border-slate-900 border rounded-lg p-2 bg-slate-200 w-full" />
                ...
                <input showonlyif="mailboxAccessScope === 'Single Mailbox'" type="email" id="primaryMailbox" className="border-slate-900 border rounded-lg p-2 bg-slate-200 w-full" />
                <label htmlFor="includeArchiveMailboxes">Include Archive Mailboxes</label>
                <input type="checkbox" id="includeArchiveMailboxes" />
                ...
                <Button type="button" className="w-full">Test Connection</Button>
